...
GLSLProgram::GLSLProgram() : _programId(0), _vertexShader(NULL), _fragmentShader(NULL), _linked(false) {}

GLSLProgram::GLSLProgram(GLSLShader *vertex, GLSLShader *fragment) : _programId(0), _vertexShader(vertex), _fragmentShader(fragment), _linked(false) {}

GLSLProgram::GLSLProgram(const char *vertexShaderFile, const char *fragmentShaderFile) : _programId(0), _linked(false)
{
